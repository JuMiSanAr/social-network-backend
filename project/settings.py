...
SECRET_KEY = 'e&e&y8y4qbrof&^h3k9^9m+fgg1osl26i2eth-+dbr!atcfw-c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = ast.literal_eval(os.environ.get('DJANGO_DEBUG'))

ALLOWED_HOSTS = ['david.eve.juan.propulsion-learn.ch', '0.0.0.0', 'localhost', '127.0.0.1']
...
CORS_ALLOWED_ORIGINS = [
    "https://david.eve.juan.propulsion-learn.ch",
    "http://localhost:3000",
    "http://localhost:8000",
    "http://0.0.0.0:8000",
    "http://127.0.0.1:8000"
